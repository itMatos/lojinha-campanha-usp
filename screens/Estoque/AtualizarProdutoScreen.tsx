...
export default function AtualizarProdutoScreen({ navigation, route }: { navigation: any; route: any }) {
    const  product = route.params;

    console.log("update: ", product);

    const [produtoNome, setProdutoNome] = useState(product.nome);
    const [produtoDescricao, setProdutoDescricao] = useState(product.descricao);
    const [produtoPreco, setProdutoPreco] = useState(product.preco.toString());
    ...
    const handleAdicionarProdutoIndividual = async () => {
        ...
        try {
            const produtoAtualizado = await updateProduct(novoProduto);
        ...
        <>
            <PaperProvider theme={paperTheme}>
                <Appbar.Header mode="center-aligned" elevated style={styles.barCima}>
                    ...
                    <Appbar.Content title="Atualizar produto" titleStyle={{color: 'white', fontFamily: 'Milky Nice'}}/>
