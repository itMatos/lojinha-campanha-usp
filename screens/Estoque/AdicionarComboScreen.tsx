                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View>
                        ...
                        Para adicionar um Combo, os itens que irão compor o combo devem ser adicionados individualmente.
                            ...
                            <Divider style={{ backgroundColor: '#B0B0B0' }}/>
                            <Button mode="contained" onPress={AdicionarFormCombo}  textColor='#2196F3' style={{ borderColor: '#2196F3', backgroundColor: 'transperant', borderWidth:1,  marginVertical: 20, marginHorizontal: 70}}>
                                Adicionar outro produto
                            </Button>
                        </View>

                            <View>
                                <Button mode="contained" onPress={handleAdicionarProdutoCombo} style={{marginLeft:90, marginRight:90, marginBottom: 10}} textColor='white' buttonColor='#2196F3'>
                                    Salvar combo
                                </Button>
                            </View>
